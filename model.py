"""
Swin-UNET++ Model Architecture
U-Net with Swin Transformer blocks for satellite to map translation
"""
...
class SwinUNetpp(nn.Module):
    """
    Swin-UNET++ Model
    U-Net architecture with Swin Transformer blocks
    """
